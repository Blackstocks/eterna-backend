...
def rolling_price_window(redis_url, channel, window_seconds=20, mark_interval_ms=50):
    ...
    def mark_ticks():
        while not stop_event.is_set():
            ...
            # Publish volatility to Redis channel 'volatility.btcusd'
            r.publish("volatility.btcusd", json.dumps({"ts": now, "volatility": volatility}))
